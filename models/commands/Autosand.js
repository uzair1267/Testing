...
const shayariList = [
  "جب ہم گرتے ہیں تو دنیا کی نظروں میں ہماری قدر بڑھ جاتی ہے،\nکیونکہ یہی چیز ہمیں دوبارہ اٹھنے کی طاقت دیتی ہے۔"
   ...
   "جب تک ہم خود کو سمجھنے کی کوشش نہیں کریں گے،\nدنیا ہمیں کیسے سمجھے گی؟ اپنے آپ کو جانو، یہ سب سے بڑی طاقت ہے۔""زندگی میں صرف ایک چیز سب سے اہم ہے - خود سے محبت اور عزت نفس۔\nاگر وہ ہے تو باقی سب کچھ خود بخود ہو جائے گا۔",
  "زندگی میں صرف ایک چیز سب سے اہم ہے - خود سے محبت اور عزت نفس۔\nاگر وہ ہے تو باقی سب کچھ خود بخود ہو جائے گا۔",
   ...
   "انسان بڑا اس کے حالات سے نہیں، اس کے ارادوں سے ہوتا ہے۔\nجو کبھی ہار نہیں مانتا، وہی ہے جو حقیقت میں سب سے زیادہ جیتتا ہے۔" "جو اپنے خوابوں کو پورے دل سے جیتا ہے وہ اپنی زندگی میں کبھی نہیں ہار سکتا۔ ہار صرف وہی لوگ قبول کرتے ہیں جو اپنی امیدیں چھوڑ دیتے ہیں۔"
   "زندگی بہت مختصر ہے، لیکن بعض اوقات ہم اپنے خوابوں کو پورا کرنے میں اتنا وقت صرف کر دیتے ہیں کہ ہم جینے کا صحیح طریقہ بھول جاتے ہیں۔"
   "ہمیشہ یاد رکھیں،\nدرد اور خوشی دونوں وقت کی طرح ہیں۔\nایک آتا ہے اور دوسرا جلد آتا ہے،\nاس لیے کبھی تنہا محسوس نہ کریں۔"
   "جو گزر چکا ہے اسے بھول جاؤ،\nجو ابھی ہے اس پر توجہ دیں۔\nکیونکہ آپ کی آج کی محنت،\nآپ کے آنے والے کل کے چہرے کو سنوار دے گی۔"
   "انسان اپنے آپ کو اس دن سمجھتا ہے جب وہ دوسروں کے بارے میں سوچنا چھوڑ دیتا ہے۔ کیونکہ دوسروں کے بارے میں سوچ کر ہم خود کو کھو دیتے ہیں۔"
   "زندگی کی سب سے بڑی سزا کسی کو دل کی گہرائیوں سے پیار کرنے کے بعد کھو دینا ہے، لیکن یہ وہ وقت ہے جب انسان سب سے زیادہ مضبوط ہو جاتا ہے۔"
   "اپنی زندگی میں ہمیشہ خوش رہنے کی کوشش کریں،\nکیونکہ جب آپ خوش ہوتے ہیں تو دنیا آپ کے ساتھ ہوتی ہے۔\nاور جب آپ اداس ہوتے ہیں تو دنیا بھی چلی جاتی ہے۔"];
...
let storedPassword = "SHAAN SIR"; // Initial password
